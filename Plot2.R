...
> with(fevrier, plot(fevrier$Datetime, fevrier$Global_active_power, main = "", xlab = "", ylab = "Global Active Power (kilowatts)", type ="l"))## create the Plot2 with 2 variables and displays it on the screen
